  ...
  "inline-flex items-center rounded-lg border px-2.5 py-0.5 text-xs font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        "inner-circle":
          "border-transparent bg-inner-circle text-inner-circle-foreground",
        "close-friends":
          "border-transparent bg-close-friends text-close-friends-foreground",
        community:
          "border-transparent bg-community text-community-foreground",
      },
    },
    defaultVariants: {
      variant: "default",

      ...
      <div className="w-full h-full flex items-center justify-center px-6 py-8">
        <div className="flex flex-col items-center gap-8 w-full max-w-md">
          <div className="text-center space-y-4">
            ...
            <p className="text-sm text-[#E5E5E5]/60 max-w-sm mx-auto">
              We sent a verification link to <strong className="text-[#E5E5E5]">{user.email}</strong>
            </p>
            <p className="text-xs text-[#E5E5E5]/50 max-w-xs mx-auto">
          ...
          <div className="flex flex-col gap-4 w-full">
            <Button
              ...
              size="lg"
              disabled={resending}
              className="w-full h-12 text-sm font-semibold tracking-wide border-[#E5E5E5]/20 text-[#E5E5E5] hover:border-[#E5E5E5]/40 hover:bg-[#E5E5E5]/5"
            >
            ...
            <Link
              href="/"
              className="text-center text-xs text-[#E5E5E5]/60 hover:underline"
            >
              Back to Home
            </Link>
          </div>

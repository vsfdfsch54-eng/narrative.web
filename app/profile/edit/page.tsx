            ...
            <div className="phone-content px-5 py-6 sm:p-4 pb-20 overflow-y-auto">
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-sm text-[#E5E5E5]/60">Update your profile information</p>
                </div>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center gap-6">
                      ...
                      <div className="flex-1">
                        <p className="text-sm text-[#E5E5E5]/60 mb-2">
                          Profile picture
                        </p>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <textarea
                          className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg focus:outline-none focus:ring-2 focus:ring-white/20 text-white placeholder:text-[#E5E5E5]/50 resize-none transition-all duration-200 min-h-[100px]"
                    ...
                    <div className="flex justify-end gap-4 pt-6 border-t border-white/10">
                      ...
                      <button
                        onClick={handleSave}
                        className="px-4 py-2 rounded-full bg-[#E5E5E5] text-[#0A0A0A] hover:bg-white/95 transition font-semibold"
                      >
                        Save Changes
                      </button>
                    </div>

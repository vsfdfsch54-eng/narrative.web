      ...
      try {
        ...
        if (createError) {
          ...
          if (createError.message.includes('duplicate key') || 
            ...
            console.log('[Connect API] User already exists, fetching...')
            ...
            if (fetchError || !existingUser) {
              console.error('[Connect API] ❌ Failed to fetch existing user:', fetchError)
              return NextResponse.json(
            ...
            console.log('[Connect API] ✅ User already exists, using existing record:', { id: userRecord.id, email: userRecord.email })
          } else {
